...
This directory contains built-in skills that extend Mikobot's capabilities.
...
When skills reference large local documentation or logs, prefer Mikobot's built-in
