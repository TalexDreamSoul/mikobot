...
- **Collaboration** (`nanobot/collaboration/`): Projects, members, and channel assignments in one local JSON store. Wired only by the gateway; the host owner's own turns bypass it. See `docs/architecture.md`.
